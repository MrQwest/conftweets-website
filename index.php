...
<body>
		...
		<ul id="conflist">
			...
			<li data-etime="2013-04-19">
				...
				<p>
					...
					<span class="webaddress"><i class="ss-icon">link</i><a href="http://events.jquery.org/2013/uk/" title="Conference website">events.jquery.org/2013/uk/</a></span>
					<span class="twitteracct"><i class="ss-icon ss-social">twitter</i><a href="http://twitter.com/jquk" title="conference twitter acct">@jquk</a></span>
				</p>
			</li>
	...
	<footer>
		<p>2011-<?php echo date(Y);?> <a href="http://mrqwest.co.uk" title="A Croydon Web Designer">MrQwest</a>, tweet me <a href="http://twitter.com/mrqwest" title="@mrqwest">@mrqwest</a></p>
	</footer>
</body>
</html>